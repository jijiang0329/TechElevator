...
select city_name, area, population
from city
where state_abbreviation in ('CT', 'ME', 'NH', 'RT', 'VT');
...
select *
from city
where city_name in ('Springfield');
...
from park
where area between 100 and 200; -- area >= 100 AND area <= 200
...
select *
from park
where date_established between '10/01/1900' and '10/01/1990';
