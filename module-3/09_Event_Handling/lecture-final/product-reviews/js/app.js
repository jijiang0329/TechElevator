...
document.addEventListener("DOMContentLoaded", () => {
    ...
    descriptionElement.addEventListener("click", (event) => {
      ...
      //target represents the html element that was originally 
    ...
    btnSaveReview.addEventListener("click", (event) => {
      ...
      //for some html elements they have default behavior to refresh
      //the page (<form>) or go to another page (<a>) and we can disable it by using
